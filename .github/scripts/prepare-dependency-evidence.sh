...
# The final gzip payload leaves one MiB of headroom beneath the previous 25 MiB
# retained-size threshold. The temporary tar is measured for audit evidence,
# but it is compressor input and is never uploaded.
