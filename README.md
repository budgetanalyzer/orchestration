...
- Before cluster apply, run `./scripts/dev/verify-phase-7-static-manifests.sh` to catch Phase 7 static manifest and setup-guidance regressions locally with the same checks the `security-guardrails.yml` workflow uses.
