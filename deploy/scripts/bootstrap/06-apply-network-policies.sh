...
phase4_warn "runtime NetworkPolicy enforcement still needs proof on the k3s CNI; run deploy/scripts/verify/network-policy-enforcement.sh before applying production secrets"
