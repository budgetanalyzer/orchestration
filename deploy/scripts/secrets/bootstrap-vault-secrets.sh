...
DEFAULT_GENERATED_ENV_FILE="${DEFAULT_OUTPUT_DIR}/secret-sync-generated-secrets.env"
...
usage() {
    cat <<'EOF'
Usage: ./deploy/scripts/secrets/bootstrap-vault-secrets.sh [options]
...
# Generated by deploy/scripts/secrets/bootstrap-vault-secrets.sh
