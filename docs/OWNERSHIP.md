...
| Dependency monitoring and upgrade policy | [docs/dependency-notifications.md](dependency-notifications.md) | Plans may capture point-in-time upgrade batches, but recurring dependency tiers, watch links, and coupling rules belong there. |
