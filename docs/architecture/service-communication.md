...
**Documentation:**
- Pattern details: [@service-common/docs/advanced-patterns.md](https://github.com/budgetanalyzerllc/service-common/blob/main/docs/advanced-patterns.md#provider-abstraction-pattern)
...
**Documentation:**
- Pattern: [@service-common/docs/advanced-patterns.md](https://github.com/budgetanalyzerllc/service-common/blob/main/docs/advanced-patterns.md#event-driven-messaging)
...
- **Patterns:** [@service-common/docs/advanced-patterns.md](https://github.com/budgetanalyzerllc/service-common/blob/main/docs/advanced-patterns.md)
