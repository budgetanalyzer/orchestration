...
| --- | --- | --- | --- | --- |
| `deploy/scripts/bootstrap/01-install-k3s.sh` | `deploy/README.md`; `docs/research/production-secrets-and-ai-agent-boundaries.md` | bootstrap order | host, cluster | cluster/platform bootstrap |
| `deploy/scripts/bootstrap/02-bootstrap-cluster.sh` | `deploy/README.md`; `docs/research/production-secrets-and-ai-agent-boundaries.md` | bootstrap order | cluster | cluster/platform bootstrap |
| `deploy/scripts/bootstrap/03-render-ingress-bootstrap-manifests.sh` | `deploy/README.md`; called by `deploy/scripts/bootstrap/04-install-istio.sh`; `docs/research/production-secrets-and-ai-agent-boundaries.md` | bootstrap order | tmp | cluster/platform bootstrap render |
| `deploy/scripts/bootstrap/04-install-istio.sh` | `deploy/README.md`; self-usage; `kubernetes/production/README.md`; `docs/research/production-secrets-and-ai-agent-boundaries.md` | bootstrap order | cluster, tmp | cluster/platform bootstrap |
| `deploy/scripts/bootstrap/05-install-platform-controllers.sh` | `deploy/README.md`; `docs/research/production-secrets-and-ai-agent-boundaries.md` | bootstrap order | cluster | cluster/platform bootstrap |
| `deploy/scripts/bootstrap/06-apply-network-policies.sh` | `deploy/README.md`; referenced by `deploy/scripts/verify/network-policy-enforcement.sh`; `docs/research/production-secrets-and-ai-agent-boundaries.md` | bootstrap order | cluster | cluster/platform bootstrap |
| `deploy/scripts/verify/network-policy-enforcement.sh` | `deploy/README.md`; `scripts/README.md`; referenced by `deploy/scripts/bootstrap/06-apply-network-policies.sh` | bootstrap order | cluster temporary probes | verification |
| `deploy/scripts/secrets/render-secret-sync.sh` | `deploy/README.md`; called by `deploy/scripts/secrets/apply-secret-sync.sh`; `docs/research/auth0-findings.md`; `kubernetes/production/README.md` | yes | tmp | continuing deployment; secret sync render |
| `deploy/scripts/secrets/apply-secret-sync.sh` | `deploy/README.md`; `docs/research/auth0-findings.md` | yes | cluster, tmp | continuing deployment; secret sync apply |
...
| `deploy/scripts/render/production-infrastructure.sh` | `deploy/README.md`; called by `deploy/scripts/reconcile/production-infrastructure.sh`; `kubernetes/production/README.md` | yes | tmp | continuing deployment; infrastructure render |
| `deploy/scripts/reconcile/production-infrastructure.sh` | `deploy/README.md`; `kubernetes/production/README.md` | yes | cluster, tmp | continuing deployment; infrastructure apply |
...
| `scripts/guardrails/check-image-pinning.sh` | `scripts/README.md`; called by `scripts/guardrails/verify-static-security-manifests.sh` | no | none | verification; lower-level guardrail |
| `scripts/guardrails/check-secrets-only-handling.sh` | `docs/development/secrets-only-handling.md`; `kubernetes/production/README.md`; `scripts/README.md`; called by `scripts/guardrails/verify-static-security-manifests.sh` | no | none | verification; lower-level guardrail |
| `scripts/guardrails/check-tilt-resource-roots.sh` | `scripts/README.md` | no | none | verification; lower-level guardrail |
| `scripts/guardrails/verify-static-security-manifests.sh` | `docs/ci-cd.md`; `docs/development/secrets-only-handling.md`; `docs/research/single-instance-demo-hosting.md`; `kubernetes/kyverno/README.md`; `scripts/README.md`; called by `scripts/smoketest/smoketest.sh` and `scripts/smoketest/verify-security-guardrails.sh` | yes | none, tmp | verification; CI-safe static guardrail |
...
| `scripts/lib/redis-cli.sh` | sourced by Redis ops scripts and `scripts/smoketest/verify-credential-isolation.sh` | library | none directly | library |
...
| `scripts/ops/post-render-prometheus-stack.sh` | `Tiltfile`; `deploy/README.md`; `deploy/scripts/reconcile/production-monitoring.sh`; `docs/architecture/observability.md`; `kubernetes/production/README.md`; `scripts/README.md`; monitoring render verifier | library | stdout, tmp | render helper |
...
| `scripts/smoketest/verify-monitoring-runtime.sh` | `deploy/scripts/reconcile/production-monitoring.sh`; `docs/development/local-environment.md`; `docs/research/prometheus-operator-rbac-baseline.md`; `scripts/README.md`; called by `smoketest.sh` and Prometheus operator verifier | yes | tmp/output artifacts through Kiali triage | verification |
...
| `scripts/smoketest/verify-credential-isolation.sh` | `docs/development/database-setup.md`; `docs/runbooks/tilt-debugging.md`; called by transport-encryption and runtime-hardening verifiers | no | none | verification; lower-level security check |
| `scripts/smoketest/verify-network-policies.sh` | `docs/architecture/port-reference.md`; `docs/runbooks/tilt-debugging.md`; image pinning inventory; called by transport-encryption and runtime-hardening verifiers | no | cluster temporary probes | verification; lower-level security check |
| `scripts/smoketest/verify-istio-ingress.sh` | `docs/architecture/security-architecture.md`; `docs/architecture/system-overview.md`; `docs/runbooks/tilt-debugging.md`; image pinning inventory; called by runtime-hardening verifier | no | temporary test/session data | verification; lower-level security check |
| `scripts/smoketest/verify-transport-encryption.sh` | `docs/development/database-setup.md`; image pinning inventory; called by runtime-hardening verifier | no | none | verification; lower-level security check |
| `scripts/smoketest/verify-runtime-hardening.sh` | `docs/architecture/security-architecture.md`; `docs/development/database-setup.md`; image pinning inventory; called by edge-browser verifier | no | cluster temporary namespace/pods | verification; lower-level security check |
| `scripts/smoketest/verify-edge-browser-hardening.sh` | `docs/architecture/security-architecture.md`; `docs/architecture/session-edge-authorization-pattern.md`; `docs/development/local-environment.md`; `nginx/README.md`; `scripts/README.md`; image pinning inventory; called by runtime security guardrail verifier | yes | temporary test/session data | verification |
| `scripts/smoketest/verify-api-rate-limit-identity.sh` | `docs/architecture/security-architecture.md`; `docs/development/local-environment.md`; `nginx/README.md`; image pinning inventory; called by edge browser verifier | no | temporary test/session data | verification; lower-level security check |
| `scripts/smoketest/verify-runtime-security-guardrails.sh` | `docs/architecture/security-architecture.md`; image pinning inventory; called by security guardrail verifier | no | cluster temporary probes/dry-runs | verification; lower-level guardrail |
| `scripts/smoketest/verify-security-guardrails.sh` | `docs/architecture/security-architecture.md`; `docs/ci-cd.md`; `docs/development/getting-started.md`; `docs/tilt-kind-setup-guide.md`; `kubernetes/kyverno/README.md`; `scripts/README.md`; called by `smoketest.sh` | yes | delegates to static and runtime verifiers | verification |
...
| `scripts/smoketest/verify-session-architecture.sh` | `docs/architecture/session-edge-authorization-pattern.md`; `docs/runbooks/tilt-debugging.md`; `scripts/README.md`; called by `smoketest.sh` | yes | none | verification |
