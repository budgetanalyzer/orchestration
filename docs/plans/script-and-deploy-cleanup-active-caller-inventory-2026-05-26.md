...
| `deploy/scripts/bootstrap/03-render-phase-4-istio-manifests.sh` | `deploy/README.md`; called by `deploy/scripts/bootstrap/04-install-istio.sh`; `docs/research/production-secrets-and-ai-agent-boundaries.md` | bootstrap order | tmp | cluster/platform bootstrap render |
...
| `deploy/scripts/secrets/render-phase-5-secrets.sh` | `deploy/README.md`; called by `deploy/scripts/secrets/apply-phase-5-secrets.sh`; `docs/research/auth0-findings.md`; `kubernetes/production/README.md` | yes | tmp | continuing deployment; secret sync render |
| `deploy/scripts/secrets/apply-phase-5-secrets.sh` | `deploy/README.md`; `docs/research/auth0-findings.md` | yes | cluster, tmp | continuing deployment; secret sync apply |
| `deploy/scripts/secrets/generate-phase-5-infra-tls.sh` | `deploy/README.md` | yes | local certificate files, cluster secrets | continuing deployment; secret bootstrap |
| `deploy/scripts/secrets/bootstrap-phase-5-vault-secrets.sh` | `deploy/README.md`; calls `deploy/scripts/secrets/update-rabbitmq-definitions-secret.sh` | yes | OCI Vault, local operator receipt | continuing deployment; secret bootstrap |
| `deploy/scripts/secrets/update-rabbitmq-definitions-secret.sh` | `deploy/README.md`; called by `deploy/scripts/secrets/bootstrap-phase-5-vault-secrets.sh` | yes | OCI Vault | continuing deployment; secret bootstrap |
| `deploy/scripts/render/phase-6-production-manifests.sh` | `deploy/README.md`; called by `deploy/scripts/release/deploy-oci-release.sh`; `kubernetes/production/README.md`; `scripts/guardrails/verify-production-image-overlay.sh` | yes | tmp | continuing deployment; production render |
| `deploy/scripts/reconcile/install-phase-7-kyverno.sh` | `deploy/README.md`; `kubernetes/kyverno/README.md`; `kubernetes/production/README.md` | yes | cluster | continuing deployment; admission bootstrap |
| `deploy/scripts/reconcile/apply-phase-7-policies.sh` | `deploy/README.md`; `kubernetes/kyverno/README.md`; `kubernetes/production/README.md` | yes | cluster | continuing deployment; admission policy apply |
| `deploy/scripts/render/phase-11-public-tls-manifests.sh` | `deploy/README.md`; referenced by `deploy/scripts/bootstrap/04-install-istio.sh` | yes | tmp | continuing deployment; public TLS render |
...
| `deploy/scripts/render/phase-7-observability.sh` | `deploy/README.md`; called by `deploy/scripts/reconcile/phase-7-observability.sh`; `kubernetes/production/README.md`; `scripts/guardrails/verify-production-image-overlay.sh` | yes | tmp | continuing deployment; observability render |
| `deploy/scripts/reconcile/phase-7-observability.sh` | `deploy/README.md`; called by `deploy/scripts/reconcile/production-monitoring.sh`; `kubernetes/production/README.md` | yes | cluster, tmp | continuing deployment; observability apply |
...
| `scripts/ops/render-istio-egress-config.sh` | `Tiltfile`; `deploy/scripts/render/phase-6-production-manifests.sh`; `docs/development/local-environment.md`; `docs/research/auth0-findings.md`; `docs/setup/auth0-setup.md`; Istio templates; `scripts/README.md` | yes | stdout/tmp; cluster with `--apply` | local ops and production render helper |
