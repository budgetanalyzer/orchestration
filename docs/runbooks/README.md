...
| [OCI Release Deployment Checklist](oci-release-deployment-checklist.md) | Evidence template for OCI desired-state deployment | Preparing or applying `kubernetes/production/apps/deployment-manifest.yaml` |
