...
> Status: this retained DinD suite is stale against the current
> Istio-only baseline and is non-gating until it is explicitly
...
Containerized runtime test harness for platform security prerequisites.
